<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Search Consultant Profile</h4>
      <br />
...
export default {
  ...
  methods: {
    ...
    async filterConsultantRecord() {
      try {
        const response = await servicesModule2.filterConsultantRecordList(
    ...
    getAllConsultantRecord: async function () {
      const response = await servicesModule2.getAllConsultant();
      this.consultantRecordList = response;
