        ...
        <div>
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    <td>Type of Setup</td>
                    <td>:</td>
                    <td>Public Listed Company/Berhad</td>
                  </tr>
                  <tr>
                    <td>Address</td>
                    <td>:</td>
            ...
            <div>
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    <td style="width: 20%">
                      Total Paid-Up Capital (RM)
                    </td>
                    <td style="width: 1%">:</td>
                    <td>RM 20,000,000</td>
                  </tr>
                  <tr>
                    <td>Type of Stucture</td>
                    <td>:</td>
                    <td>Single-tier</td>
                  </tr>
                  <tr>
                ...
                <table class="table table-striped">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        No 53,Jalan Kajang Perdan 2/5,Taman Kajang Perdana
                      </td>
                    </tr>
                    <tr>
                      <td>Postcode</td>
            ...
            <div>
              ...
              <div>
                <a
                  ...
                  target="_blank"
                >
                  View Receipt Payment &nbsp; <i class="fa fa-eye"
                /></a>
              </div>
              <!-- <table>
                <tr>
              ...
              <div class="row justify-content-center">
                <div class="col-lg-12">
                  ...
                  >
                    ...
                    <br />
                    <div id="app" class="ml-4 col-md-10">
                      <VueFileAgent
                        ref="vueFileAgent"
                        :theme="'list'"
                        :multiple="true"
            ...
            <div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    <td>
                      1. Board of Directors' Resolution approving the
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    <td>
                      2. Certified true copy of relevant CMSL and approval that
                      verify the eligibility of the applicant (if applicable)
                      &nbsp; &nbsp; &nbsp;
                      <a
                        href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                        target="_blank"
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    <td>
                      4. Printed online applicationType &nbsp; &nbsp;&nbsp;
                      <a
                        href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                        target="_blank"
                        class="row"
          ...
          <div v-if="currentTab === 'tab8'">
            ...
            <button
              ...
              type="button"
              class="ml-4 btn btn-warning btn-fill btn-md"
            >
              Governance on marketing and distribution activities &nbsp;
              <i class="fa fa-caret-square-o-down" />
            </button>
            &nbsp;
            <button
            ...
            <div class="ml-4">
              <b-collapse id="collapse-11" class="mt-2">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        1. Policy governing Sales Conduct / Activities &nbsp;
                        &nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        2. Policy on promotional Materials &nbsp; &nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                          class="row"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        3. Policy on Unitholder’s Rights and Protection
                        &nbsp;&nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        7. Complaint Handling and Disciplinary matrix &nbsp;
                        &nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        8. Other Policies – upload related policy available
                        (i.e. AMLCFT, PDPA, etc.) &nbsp; &nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
              ...
              <b-collapse id="collapse-12" class="mt-2">
                ...
                <br />
                <h4 class="card-title">
                  Part 2 :Management of Unitholders
                </h4>
                <br />
                <table class="table table-striped">
                  <tr>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        1. Unitholder’s KYC process, records and system
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                          class="row"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        2. Redemption process - upload related policy (checking,
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        5. Reconciliation of subscriptions/ redemptions/
                        transfers &nbsp; &nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        6.Management of Statements to investors &nbsp; &nbsp;
                        &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
              ...
              <b-collapse id="collapse-13" class="mt-2">
                ...
                <br />
                <h4 class="card-title">
                  Part 3 :Management of Consultants
                </h4>
                <br />
                <table class="table table-striped">
                  <tr>
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        3. Consultant Record Management and Maintenance System
                        &nbsp;&nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        4. Consultant Record Management and Maintenance System
                        &nbsp; &nbsp;&nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                ...
                <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td>
                        6. Training & CPD Record Management &nbsp; &nbsp; &nbsp;
                        <a
                          href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                          target="_blank"
                          class="row"
...
export default {
  ...
  mounted() {
    this.getDistributorById(this.dist_id);
  },
