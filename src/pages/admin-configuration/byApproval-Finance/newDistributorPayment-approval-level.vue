        ...
        <h4 slot="header">APPROVAL LEVEL</h4>
         ...
         <va-card class=" ml-4 col-lg-10 my-1 px-1">
            ...
            <h4 slot="header">
              ...
              COMPANY REGISTRATION PAYMENT - E(1)(a)
            </h4>
            </div>
            <br>
           <div class="ml-5">
  ...
  mounted() {
   ...
   data() {
        return {
          ...
          approvalLevelList: [
        { 
          id: "1", name: "FINANCE REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
        ...
        onToggleChange(item,event){
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','COMPANY REGISTRATION PAYMENT - E(1)(a)');
              try {
                // eslint-disable-next-line no-unused-vars
