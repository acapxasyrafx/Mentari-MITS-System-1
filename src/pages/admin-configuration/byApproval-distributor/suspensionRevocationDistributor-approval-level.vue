        ...
        <h4 slot="header">APPROVAL LEVEL</h4>
         ...
         <va-card class=" ml-4 col-lg-10 my-1 px-1">
            ...
            <h4 slot="header">
              ...
              SUSPENSION AND REVOCATION - A(1)(c)(ii)
            </h4>
            </div>
            <br>
           <div class="ml-5">
  ...
  mounted() {
   ...
   data() {
        return {
          ...
          approvalLevelList: [
        { 
          id: "1", name: "FIRST LEVEL HOD REGISTRATION DEPARTMENT REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
        ...
        { id: "2", name: "GM RECOMMENDATION REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"",toggleStatus:0, datatoggle:false, compType: [
                 {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        { id: "3", name: "CHIEF OF EXECUTIVE REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
                 {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        { id: "4", name: "REGISTRATION DEPARTMENT REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
                {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        { id: "5", name: "SECOND LEVEL HOD REGISTRATION DEPARTEMENT REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
               {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        { id: "6", name: "SECOND LEVEL GM RECOMMENDATION REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
               {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        { id: "7", name: "SECOND LEVEL CHIEF OF EXECUTIVE REVIEW",predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
               {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        onToggleChange(item,event){
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','SUSPENSION AND REVOCATION - A(1)(c)(ii)');
              try {
                // eslint-disable-next-line no-unused-vars
