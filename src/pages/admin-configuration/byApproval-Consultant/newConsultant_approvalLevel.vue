  ...
  mounted() {
   ...
   data() {
        return {
          ...
          approvalLevelList: [
        { 
          id: "1", name: "ADMINSTRATOR FOR DISTRIBUTOR REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
        ...
        { id: "2", name: "MANAGER FOR DISTRIBUTOR REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"",toggleStatus:0, datatoggle:false, compType: [
                   {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
     ...
     methods: {
        ...
        onToggleChange(item, event){
          ...
          const response = await servicesModule0.getAllApprovalList('New Consultant - A(2)(a)');
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','New Consultant - A(2)(a)' );
              try {
                // eslint-disable-next-line no-unused-vars
