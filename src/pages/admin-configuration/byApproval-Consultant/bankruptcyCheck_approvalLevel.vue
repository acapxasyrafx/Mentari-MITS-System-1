...
export default {
  ...
  mounted() {
   ...
   data() {
        ...
        { 
          id: "2", name: "REGISTRATION DEPARTMENT REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
               {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        onToggleChange(item,event){
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','BANKRUPTCY CHECK - A(2)(i)');
              try {
                // eslint-disable-next-line no-unused-vars
