  ...
  mounted() {
   ...
   data() {
        return {
          ...
          approvalLevelList: [
        { 
          id: "1", name: "ADMINISTRATOR OF DISTRIBUTOR REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
         ...
         { 
          id: "2", name: "MANAGER OF DISTRIBUTOR REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
               {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        { 
          id: "3", name: "REGISTRATION DEPARTMENT REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
               {id: 1, name: "UTMC", selected: false},
                {id: 2, name: "IUTA", selected: false},
                {id: 3, name: "CUTA", selected: false},
                {id: 5, name: "CPRA", selected: false},
        ...
        onToggleChange(item,event){
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','APPEAL- A(2)(j)');
              try {
                // eslint-disable-next-line no-unused-vars
