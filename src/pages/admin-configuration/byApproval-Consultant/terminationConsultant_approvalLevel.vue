  ...
  mounted() {
   ...
   data() {
        return {
          ...
          approvalLevelList: [
        { 
          id: "1", name: "HEAD OF DEPARMENT REGISTRATION DEPARTMENT REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
        ...
        onToggleChange(item,event){
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','TERMINATION - A(2)(d)');
              try {
                // eslint-disable-next-line no-unused-vars
