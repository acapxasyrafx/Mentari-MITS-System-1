        ...
        <h4 slot="header">APPROVAL LEVEL</h4>
         ...
         <va-card class=" ml-4 col-lg-10 my-1 px-1">
            ...
            <h4 slot="header">
              ...
              CONSULTANT CASE MANAGEMENT - B(1)(a)
            </h4>
            </div>
            <br>
           <div class="ml-5">
  ...
  mounted() {
   ...
   data() {
        return {
          ...
          approvalLevelList: [
        { 
          id: "1", name: "GENERAL MANAGER OF REGULATORY SERVICE DIVISION REVIEW", predecessor:"", autoApprovalDay:"", autoRejectDay:"", toggleStatus:0, datatoggle:false, compType: [
        ...
        onToggleChange(item,event){
          ...
          async submit(item){
            ...
            const data = new FormData();
                ...
                data.append('APPR_PROCESSFLOW_NAME','CONSULTANT CASE MANAGEMENT - B(1)(a)');
              try {
                // eslint-disable-next-line no-unused-vars
