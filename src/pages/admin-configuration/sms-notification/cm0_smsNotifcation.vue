...
export default {
  ...
  methods: {
    ...
    async editExceptionAPI() {
      try {
        alert(this.model.modelEdit.SMS_HTTP_URL);
        const data = new FormData();
        data.append(
          "SETTING_SMS_ID",
          this.model.modelEdit.SETTING_SMS_ID
        );
        data.append("SMS_HTTP_URL", this.model.modelEdit.SMS_HTTP_URL);
        data.append(
          "SMS_HTTP_URL",
          moment(this.model.modelEdit.SMS_HTTP_URL)
        );
        data.append(
          "SMS_HTTP_PARAM",
          moment(this.model.modelEdit.SMS_HTTP_PARAM)
        );
        data.append(
          "SMS_REQ_HEADER",
          this.model.modelEdit.SMS_REQ_HEADER
        );
		data.append(
          "SMS_REQ_HEADER",
          this.model.modelEdit.SMS_REQ_HEADER
		...
		data.append(
          "SMS_RES_SUCCESS",
          this.model.modelEdit.SMS_RES_SUCCESS
        );
		data.append(
          "SMS_RES_FAILURE",
          this.model.modelEdit.SMS_RES_FAILURE
        );
