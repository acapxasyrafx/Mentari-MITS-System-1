          ...
          <div class="col-lg-12">
            ...
            >
              <h4 slot="header" class="card-title">
                Distributor Cessation Request Form
              </h4>
                    ...
                    <div class="ml-4">
                      ...
                      <table class="table table-striped">
                        <tbody>
                          ...
                          <tr>
                            <td>Distributor Registration No</td>
                            <td>:</td>
                            <td>871180-W</td>
                          </tr>
                          <tr>
                            <td>New Distributor Registration No</td>
                            <td>:</td>
                            <td>871180-W</td>
                          </tr>
                          <tr>
                        ...
                        <table class="table table-striped">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>:</td>
                              <td>
                                No 53,Jalan Kajang Perdan 2/5,Taman Kajang
                                Perdana
                              </td>
                            </tr>
                            <tr>
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>2</td>
                            <td>
                              Certified true copy of relevant CMSL and approval
                              that verify the eligibility of the applicant (if
                              applicable) &nbsp; &nbsp; &nbsp;
                              <a
                                href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                                target="_blank"
                          ...
                          <tr>
                            <td>4</td>
                            <td>
                              Printed online applicationType &nbsp; &nbsp;
                              &nbsp;
                              <a
                                href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                                target="_blank"
          ...
          <div class="col-lg-12">
            ...
            >
              ...
              <div>
                <tabs
                  :tabs="tabscessation"
                  :currentTab="currentTabCessation"
                  :wrapper-class="'default-tabs'"
                  :tab-class="'default-tabs__item'"
                  :tab-active-class="'default-tabs__item_active'"
                  :line-class="'default-tabs__active-line'"
                  @onClick="handleClickcessation"
                />
                <div class="content">
                  <div v-if="currentTabcessation === 'tabcessation1'">
                    <div class="ml-4">
                      <br/>
                      <table class="table table-striped">
                        <tbody>
                          ...
                          <tr>
                            <td style="width: 20%">name of the distributor involved in the merger and acquisition</td>
                            <td style="width: 1%">:</td>
                  ...
                  <div v-if="currentTabcessation === 'tabcessation2'">
                    <div class="ml-4">
                      <br/>
                      <table class="table table-striped">
                        <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>2</td>
                            <td>
                              Court Vesting Order(for merger and acquisition only) &nbsp; &nbsp; &nbsp;
                              <a
                                href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                                target="_blank"
                                class="row"
                          ...
                          <tr>
                            <td>3</td>
                            <td>
                              A copy of Form 13 (for merger and acquisition only)&nbsp;
                              &nbsp; &nbsp;
                              <a
                                href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                                target="_blank"
                          ...
                          <tr>
                            <td>4</td>
                            <td>
                              A copy of Form 18 from Securities Commission (for CMSL Holder, if applicable) &nbsp; &nbsp;
                              &nbsp;
                              <a
                                href="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"
                                target="_blank"
              ...
              <form class="ml-3">
                ...
                <div class="float-right">
                  <button
                    @click="saveAsDraft"
                    type="button"
                    class="mr-2 btn btn-secondary btn-fill btn-md"
                  >
...
export default {
  ...
  data () {
    return {
      ...
      tabscessation: TABSCESSATION,
      currentTabCessation: 'tabcessation1',
